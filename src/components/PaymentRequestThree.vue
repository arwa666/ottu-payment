...
<div  class="height100">
  <div  class="ottu-header white-bg" >
    
         <v-layout row justify-center align-center class="height100 custom-toolbar">
            <v-flex class="d-flex" justify-space-between xs11 sm10 md9 xl6 >
               <div> 
                 <v-img  src="images/logo-with-bg.png"
                  height = "77"
                  width="73"/>
                </div>
       ...
       <v-flex xs11 sm10 md9 xl6>
           <!-- First Section -->
                ...
                <v-card class="first-section">
                    <v-layout row wrap >
                        <v-flex  xs6 sm6 md6 class="sender">
                            ...
                            <h4 class="name">Mughal Mahal</h4>
                            <div class="email break-word">www.mughalmahal.com</div>
                        </v-flex>
                        <v-flex xs6 sm6 md6 class="receiver">
                                <div class="first-section-title">
                                To
                                </div>
                                <h4 class="name">Saif Taher</h4>
                                <div class="email break-word">saif@ottu.com</div>
            ...
            <v-card class="third-section">
                        ...
                        <div class="d-none-m">
                            <svg xmlns="http://www.w3.org/2000/svg" width="148" height="24" viewBox="0 0 148 24">
                                <g id="Group_1353" data-name="Group 1353" transform="translate(0 -6)">
                                    <g id="Group_1312" data-name="Group 1312" transform="translate(0 6)">
                                    ...
                                    <text id="Payment_Details" data-name="Payment Details" transform="translate(40 24)" fill="#b1b9cc" font-size="16" font-family="SegoeUI, Segoe UI" letter-spacing="-0.024em"><tspan x="0" y="0">Payment Details</tspan></text>
                                </g>
                            </svg>
                ...
                <v-layout class="mt-25 justify-center">
                    <div class="total-text">
                        <b>+1.500</b> KWD Will Be Applied
                    </div>
                </v-layout>
...
.ottu-header.white-bg{
    background-color: white!important;
    box-shadow: none!important;
    height: 90px!important;
   
}
.white-bg .lang-toggler{
    color:#302F37;
    display: flex;
